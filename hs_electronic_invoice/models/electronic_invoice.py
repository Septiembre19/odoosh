...
class electronic_invoice(models.Model):
    ...
    numeroDocumentoFiscal = fields.Integer(
        string="No. Factura Documento Fiscal")
    numeroDocumentoFiscalNC = fields.Integer(
        string="No. Nota de Crédito Documento Fiscal")
