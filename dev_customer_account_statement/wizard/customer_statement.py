...
class customer_statement(models.TransientModel):
    ...
    month = fields.Selection([('1','ENE'),('2','FEB'),('3','MAR'),('4','ABR'),('5','MAY'),('6','JUN'),('7','JUL'),('8','AGO'),('9','SEP'),('10','OCT'),('11','NOV'),('12','DIC')], string='Mes')
    aging_by = fields.Selection([('inv_date','Fecha de Factura'),('due_date','Fecha de vencimiento')],string='Mostrar por', default='due_date', required="1")
    
    date_upto = fields.Date('Upto Date',required="1", default=datetime.date.today())
    is_privious_year = fields.Boolean('Imprimir año anterior')
    ...
    def send_statement(self):
        ...
        for partner in partner_ids:
            ...
            mtp.send_mail(partner.id,force_send=True)
